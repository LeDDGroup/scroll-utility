...
const easing = {
    ...
    in: {
        ...
        quint: function(currentStep: number, offsetValue: number, distance: number, totalSteps: number) {
            currentStep /= totalSteps;
            return distance * currentStep * currentStep * currentStep * currentStep * currentStep + offsetValue;
        },
        quart: function(currentStep: number, offsetValue: number, distance: number, totalSteps: number) {
            currentStep /= totalSteps;
            return distance * currentStep * currentStep * currentStep * currentStep + offsetValue;
        },
        cubic: function(currentStep: number, offsetValue: number, distance: number, totalSteps: number) {
            currentStep /= totalSteps;
